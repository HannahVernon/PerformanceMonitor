...
WPF desktop application for the Full Edition. Connects to SQL Server instances running the PerformanceMonitor database and visualizes collected performance data across six tab groups: Overview, Performance, Resource Metrics, Memory, Locking, and System Events.
