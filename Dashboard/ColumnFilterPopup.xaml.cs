...
namespace PerformanceMonitorDashboard
{
    public partial class ColumnFilterPopup : UserControl
    {
        ...
        public void Initialize(string columnName, ColumnFilterState? existingFilter)
        {
            ...
            {
                OperatorComboBox.SelectedIndex = 0; // Contains
            ...
            // Focus the value textbox for quick typing
            ValueTextBox.Focus();
        ...
        private void UpdateValueVisibility()
        {
            ...
            // Hide value input for IsEmpty/IsNotEmpty operators
        ...
        private void ValueTextBox_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                // Close popup - parent will handle this
