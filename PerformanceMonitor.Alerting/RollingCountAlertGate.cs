...
/// <summary>
/// Edge-trigger gate for the alert engine's rolling-window count alerts —
...
///
/// Moved verbatim from Lite's <c>PerformanceMonitorLite.Services</c> in Phase-5 slice D so the
/// shared <see cref="AlertEngine"/> and Lite's loop run the SAME gate; Lite call sites alias
/// this type.
/// </summary>
