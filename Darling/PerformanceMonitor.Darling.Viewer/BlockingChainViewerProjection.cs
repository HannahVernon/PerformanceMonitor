...
/// Common but not Analysis; Analysis does not reference Common by design). Copied byte-identical from
/// Lite's/Dashboard's copy (W1e copy-parity — the viewer owns its own copy; Lite/Dashboard are untouched).
/// </summary>
