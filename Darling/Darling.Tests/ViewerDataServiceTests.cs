...
public sealed class ViewerSchemaVersionGateTests
{
    ...
    [Theory]
    [InlineData(true, true, true, true, true, true, true, true, true, true, true, true, true, true, 30)]  // fully migrated V30 (config_service web_enabled, #1562)
    [InlineData(true, true, true, true, true, true, true, true, true, true, true, true, true, false, 29)]  // V29: long_query_completions present, web config not yet (#1496)
    [InlineData(true, true, true, true, true, true, true, true, true, true, true, true, false, false, 28)]  // V28: query_store_stats replica_role present, long_query_completions not yet (#1546)
    [InlineData(true, true, true, true, true, true, true, true, true, true, true, false, false, false, 27)] // V27: deadlocks database_name present, replica_role not yet (#1535)
    [InlineData(true, true, true, true, true, true, true, true, true, true, false, false, false, false, 26)] // V26: generic webhook present, deadlocks column not yet
    [InlineData(true, true, true, true, true, true, true, true, true, false, false, false, false, false, 25)] // V25: agent_status present, generic webhook not yet
    [InlineData(true, true, true, true, true, true, true, true, false, false, false, false, false, false, 24)] // V24: job_history present, agent_status not yet
    [InlineData(true, true, true, true, true, true, true, false, false, false, false, false, false, false, 23)]    // V23 (collection_log hypertable, or plain-PG at V23)
    [InlineData(true, true, true, true, true, true, false, false, false, false, false, false, false, false, 22)]   // Timescale store still at V22 (index present, collection_log not yet a hypertable)
    [InlineData(true, true, true, true, true, false, false, false, false, false, false, false, false, false, 21)]  // pre-V22: has default_trace_events, no V22 index
    [InlineData(true, true, true, true, false, false, false, false, false, false, false, false, false, false, 20)] // pre-V21: no default_trace_events
    [InlineData(true, true, true, false, false, false, false, false, false, false, false, false, false, false, 19)]// pre-V20: no alert-tuning knobs
    [InlineData(true, true, false, false, false, false, false, false, false, false, false, false, false, false, 18)]// pre-V19: no analysis_state
    [InlineData(true, false, false, false, false, false, false, false, false, false, false, false, false, false, 17)]// pre-V18: no delivery-override column
    [InlineData(false, false, false, false, false, false, false, false, false, false, false, false, false, false, 16)]// pre-V17: no config control plane at all
    public void MapProbedSchemaVersion_TakesTheHighestSatisfiedSentinel(
        bool hasConfigControlPlane, bool hasAlertDeliveryOverride, bool hasAnalysisState, bool hasAlertTuningKnobs, bool hasDefaultTraceEvents, bool hasIndexObjectStatsLatestIndex, bool hasCollectionLogHypertableOrPlainPg, bool hasJobHistory, bool hasAgentStatus, bool hasGenericWebhook, bool hasDeadlocksDatabaseName, bool hasQueryStoreReplicaRole, bool hasLongQueryCompletions, bool hasWebDashboardConfig, int expected)
    {
        Assert.Equal(expected, ViewerDataService.MapProbedSchemaVersion(
            hasConfigControlPlane, hasAlertDeliveryOverride, hasAnalysisState, hasAlertTuningKnobs, hasDefaultTraceEvents, hasIndexObjectStatsLatestIndex, hasCollectionLogHypertableOrPlainPg, hasJobHistory, hasAgentStatus, hasGenericWebhook, hasDeadlocksDatabaseName, hasQueryStoreReplicaRole, hasLongQueryCompletions, hasWebDashboardConfig));
    }
    ...
    public void MapProbedSchemaVersion_V23CompositeIsGatedBehindV22_NotAStandaloneTopArm()
    {
        ...
        Assert.Equal(21, ViewerDataService.MapProbedSchemaVersion(true, true, true, true, true, false, true, false, false, false, false, false, false, false));
    }
    ...
    public void RequiredStoreSchemaVersion_TracksTheBuildSchemaVersion_AndTheProbeCoversIt()
    {
        ...
        Assert.Equal(
            ...
            ViewerDataService.MapProbedSchemaVersion(true, true, true, true, true, true, true, true, true, true, true, true, true, true));
    }
}
