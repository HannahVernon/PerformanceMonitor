...
public partial class PlanViewerControl : UserControl
{
    ...
    private void ShowMissingIndexes(System.Collections.Generic.List<MissingIndex> indexes)
    {
    ...
    private void ShowWaitStats(System.Collections.Generic.List<WaitStatInfo> waits, bool isActualPlan)
    {
