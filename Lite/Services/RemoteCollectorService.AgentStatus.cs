...
public partial class RemoteCollectorService
{
    ...
    /// Running" alert. Read-only. Not collected on Azure SQL DB (AppliesTo skips) nor AWS RDS
    /// (sys.dm_server_services is unavailable there — gated in IsCollectorSupported), and gated off when the
    /// login lacks msdb access.
    /// </summary>
