...
ORDER BY
    ...
    public override IReadOnlyList<CollectorColumn> PayloadColumns { get; } = new[]
    {
        ...
        new CollectorColumn("reserved_mb", CollectorColumnType.Decimal),
        new CollectorColumn("used_mb", CollectorColumnType.Decimal),
        new CollectorColumn("in_row_data_mb", CollectorColumnType.Decimal),
        new CollectorColumn("lob_data_mb", CollectorColumnType.Decimal),
        new CollectorColumn("row_overflow_mb", CollectorColumnType.Decimal),
