...
OPTION(RECOMPILE);";
    ...
    public override IReadOnlyList<CollectorColumn> PayloadColumns { get; } = new[]
    {
        ...
        new CollectorColumn("total_memory_mb", CollectorColumnType.Decimal),
        new CollectorColumn("available_memory_mb", CollectorColumnType.Decimal),
        new CollectorColumn("granted_memory_mb", CollectorColumnType.Decimal),
        new CollectorColumn("used_memory_mb", CollectorColumnType.Decimal),
