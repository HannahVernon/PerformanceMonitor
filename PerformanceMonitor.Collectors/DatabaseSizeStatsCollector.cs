...
OPTION(RECOMPILE);";
    ...
    public override IReadOnlyList<CollectorColumn> PayloadColumns { get; } = new[]
    {
        ...
        new CollectorColumn("total_size_mb", CollectorColumnType.Decimal),
        new CollectorColumn("used_size_mb", CollectorColumnType.Decimal),
        new CollectorColumn("auto_growth_mb", CollectorColumnType.Decimal),
        new CollectorColumn("max_size_mb", CollectorColumnType.Decimal),
        ...
        new CollectorColumn("volume_total_mb", CollectorColumnType.Decimal),
        new CollectorColumn("volume_free_mb", CollectorColumnType.Decimal),
